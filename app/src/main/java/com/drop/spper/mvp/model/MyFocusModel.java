...
@ActivityScope
public class MyFocusModel extends BaseModel implements MyFocusContract.Model {
    private Gson mGson;
    private Application mApplication;
    private static final int COUNT = 10;

    @Inject
    public MyFocusModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<HotMovieBean> getMyFocus(int start, boolean updata) {
