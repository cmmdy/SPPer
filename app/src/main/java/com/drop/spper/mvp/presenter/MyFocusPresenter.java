...
@ActivityScope
public class MyFocusPresenter extends BasePresenter<MyFocusContract.Model, MyFocusContract.View> {
    ...
    @Inject
    public MyFocusPresenter(MyFocusContract.Model model, MyFocusContract.View rootView
    ...
    public void requestMyFocus(boolean pullToRefresh) {
        ...
        mModel.getMyFocus(lastStart, isEvictCache)
