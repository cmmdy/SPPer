...
public class AccountActivity extends BaseActivity<AccountPresenter> implements AccountContract.View, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initData(Bundle savedInstanceState) {
        mPresenter.requestAccount(true);
        ...
        if (mPaginate == null) {
            Paginate.Callbacks callbacks = new Paginate.Callbacks() {
                ...
                public void onLoadMore() {
                    mPresenter.requestAccount(false);
                }
