...
public class WalletModel extends BaseModel implements WalletContract.Model {
    ...
    @Inject
    public WalletModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<HotMovieBean> getWallet(int start, boolean updata) {
